...
function writeParameterFixtures() {
	...
	return {
		...
		"acct.invoice.customer_post.v1": {
			...
			expected_document_binding_v2: "c7aca8ffb22ffad4912060e3d7bce91cf8517a12b49adc86d97f203c463f1f76",
			expected_business_binding: "f8ee1a6a51089041ccab4461b459d3f38e1a581fc96f90a3f1784ed511e2946a",
			expected_partner_id: 901,
			expected_journal_id: 31,
			expected_currency_id: 12,
			expected_payment_term_line_id: 6203,
			...
			expected_amount_total: "300.00",
			expected_amount_residual: "300.00",
		...
		"acct.bill.vendor_post.v1": {
			...
			expected_document_binding_v2: "9e88c0447f636ac9c42bf8350903912486194890904d0ef249f4a6e77e63880a",
			...
			expected_currency_id: 12,
			expected_payment_term_line_id: 6213,
			...
			expected_amount_tax: "0.00",
			expected_amount_total: "880.00",
			expected_amount_residual: "880.00",
		...
		"acct.move.draft_cancel.v2": {
			...
			expected_document_binding_v2: null,
		...
		"acct.move.draft_cancel.v1": {
			...
			expected_document_binding_v2: "f".repeat(64),
		...
		"acct.refund.draft_cancel.v1": {
			...
			expected_document_binding_v2: "9b7e6e7694c60e3fdcdfd5fb84b54f9ac8811cbea87a40cb78693982327a7d64",
			...
			expected_origin_document_binding_v2: "76e7a2cf617db9aeecc9548648abd11364200f13a47fd4abd7cf3d901135d29b",
