...
DEV9_SECURITY_RELEASE_MEMBERS = frozenset(
    {
        ...
        "src/odoo_accounting_cli_v3/trusted_result_delivery.py",
        ...
        "tests/test_trusted_result_delivery.py",
...
DEV262_READ_EVIDENCE_INDEX_RELEASE_MEMBERS = frozenset(
    {
        ".github/workflows/quality.yml",
        "README.md",
        "VERSION",
        ...
        "src/odoo_accounting_cli_v3/cli.py",
        "src/odoo_accounting_cli_v3/read_evidence_index.py",
        "src/odoo_accounting_cli_v3/sshsig.py",
        "tests/TEST.md",
        "tests/test_cli_evidence.py",
        "tests/test_read_evidence_index.py",
        "tests/test_release_archive.py",
...
DEV264_READ_EVIDENCE_FOUNDATION_RELEASE_MEMBERS = frozenset(
    {
        ".github/workflows/quality.yml",
        "README.md",
        "VERSION",
        "docs/DEPLOYMENT.md",
        "docs/READ_EVIDENCE_INDEX.md",
        "docs/TARGET_HOST_DEV263_SIDELOAD_2026-08-10.md",
        "src/odoo_accounting_cli_v3/read_evidence_publication.py",
        "src/odoo_accounting_cli_v3/read_evidence_raw_v3.py",
        "tests/TEST.md",
        "tests/test_read_evidence_publication.py",
...
DEV266_CI_REMEDIATION_RELEASE_MEMBERS = frozenset(
    {
        ...
        "deployment/dev29/runtime_open_trace.py",
        "docs/DEPLOYMENT.md",
        "docs/PI_MULTITURN_SECURITY_DESIGN.md",
        "docs/PI_SCENARIO_ACCEPTANCE.md",
        "docs/READ_EVIDENCE_INDEX.md",
        "docs/RUNTIME_CONFIGURATION.md",
        "pi_bridge/bootstrap.mjs",
...
WRITE_RUNTIME_RELEASE_MEMBERS = frozenset(
    {
        ...
        "src/odoo_accounting_cli_v3/document_bindings.py",
        "src/odoo_accounting_cli_v3/draft_invoice_recovery.py",
        "src/odoo_accounting_cli_v3/partial_refund_lineage.py",
        ...
        "tests/test_auth.py",
        "tests/test_accounting_metadata_guard.py",
        "tests/test_bank_statement_compensate_odoo_facade.py",
        "tests/test_bank_statement_compensation_broker.py",
        "tests/test_bank_statement_compensation_service.py",
        "tests/test_bank_statement_sequence_guard_addon.py",
        "tests/test_cli_write.py",
        "tests/test_cli_evidence.py",
        "tests/test_dev260_failclosed_boundaries.py",
        "tests/test_dev260_partial_refund_lineage.py",
        "tests/test_document_bindings.py",
        "tests/test_gateway.py",
        ...
        "tests/test_mail_thread_projection_addon.py",
        ...
        "odoo_addons/odoo_accounting_cli_v3_control/models/bank_statement_sequence_guard.py",
        ...
        "pi_bridge/server.mjs",
        "pi_bridge/tests/final-evidence.test.mjs",
        "pi_bridge/tests/final-result-delivery.test.mjs",
        "pi_bridge/tests/odoo-v3-cli.test.mjs",
        "pi_bridge/tests/server-final-evidence.test.mjs",
